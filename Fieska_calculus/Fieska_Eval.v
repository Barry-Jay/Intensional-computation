...
Lemma eval_app_from_Fieska : forall M N, sf_red (App M N) (eval_app M N).
Proof. 
induction M; split_all. 
case o; split_all. red; one_step. 
gen_case IHM1 M1. gen_case IHM1 o.  red; one_step. 
gen_case IHM1 f. gen_case IHM1 o. red; one_step. 
gen_case IHM1 f0. red; one_step. 
red; one_step. 
Qed. 


Fixpoint eval0 (M: Fieska) :=
match M with 
| Ref i => Ref i 
| Op o => Op o
...
Lemma eval0_from_Fieska : forall M, sf_red M (eval0 M).
Proof. 
induction M; split_all.
eapply transitive_red. 
eapply preserves_app_sf_red. eapply2 IHM1. auto. 
eapply transitive_red. 
eapply2 eval_app_from_Fieska. 
case M1; split_all. 
case o; split_all. 
