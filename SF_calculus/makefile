...
makefile.conf: 
	coq_makefile -o makefile Adding.v Equal.v Extensions.v Fixpoints.v General.v SF_Closed.v SF_Eval.v SF_Normal.v SF_Tactics.v SF_Terms.v SF_reduction.v SF_size.v Star.v Substitution.v Tagging.v Test.v
