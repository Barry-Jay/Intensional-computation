...
Fixpoint l2SF (t: lambda) := 
match t with 
| Closure_calculus.Ref i => App (Op Var) (ref i)
| Closure_calculus.Tag s t => App (App (Op Tag) (l2SF s)) (l2SF t)
| Closure_calculus.App t u => App (l2SF t) (l2SF u) 
| Closure_calculus.Iop => Op Iop
| Closure_calculus.Add sigma i u => App (App (App (Op Add) (l2SF sigma)) (ref i)) (l2SF u)
| Closure_calculus.Abs sigma j t => App (App (App (Op Abs) (l2SF sigma)) (ref j)) (l2SF t)
end.


Lemma l2SF_preserves_red: forall M N, seq_red1 M N -> c_red (l2SF M) (l2SF N).
Proof.
...
Lemma l2SF_preserves_normal : forall M, Closure_calculus.normal M -> normal (l2SF M). 
